...
# Script is 'slow' (127 symbols passwords in 0.50 seconds)
#
# Description END
...
typeset passFile='aPasswdsAlnum.txt'
...
jot -r -w '%d' ${passLength}00 '0.01' '61.99' |
  ...
  do
    ...
    fold -w $passLength |
    sed -e "s/\(.\)\1/${arrSymbols[RANDOM%62]}${arrSymbols[RANDOM%62]}/g" \
      -e "s/\(.\)\1/${arrSymbols[RANDOM%62]}${arrSymbols[RANDOM%62]}/g" \
      -e "s/\(.\)\1/${arrSymbols[RANDOM%62]}${arrSymbols[RANDOM%62]}/g" >| "$scriptRoot$passFile"
print -- '' >> "$scriptRoot$passFile"
